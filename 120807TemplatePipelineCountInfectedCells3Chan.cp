...
LoadImages:[module_num:1|svn_version:\'11587\'|variable_revision_number:11|show_window:False|notes:\x5B\x5D]
    ...
    Channel number:1
    Rescale intensities?:Yes
    Text that these images have in common (case-sensitive):\\w*w3.TIF
...
IdentifySecondaryObjects:[module_num:3|svn_version:\'10826\'|variable_revision_number:7|show_window:True|notes:\x5B\x5D]
