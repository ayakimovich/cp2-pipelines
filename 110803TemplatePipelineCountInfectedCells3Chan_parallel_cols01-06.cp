...
LoadImages:[module_num:1|svn_version:\'10951\'|variable_revision_number:11|show_window:False|notes:\x5B\x5D]
    ...
    Image count:3
    Text that these images have in common (case-sensitive):\\w*1\x5B0-2\x5D\\w*w1.TIF
    ...
    Text that these images have in common (case-sensitive):\\w*1\x5B0-2\x5D\\w*w2.TIF
    ...
    Channel number:1
    Rescale intensities?:Yes
    Text that these images have in common (case-sensitive):\\w*1\x5B0-2\x5D\\w*w3.TIF
    ...
    Load the input as images or objects?:Images
    Name this loaded image:RedChan
    Name this loaded object:Nuclei
    Retain outlines of loaded objects?:No
...
MeasureObjectIntensity:[module_num:6|svn_version:\'10816\'|variable_revision_number:3|show_window:True|notes:\x5B\x5D]
    Hidden:1
    Select an image to measure:RedChan
    Select objects to measure:Cells
    Select objects to measure:DetectedNuclei
    Select objects to measure:Cytoplasm
