...
LoadImages:[module_num:1|svn_version:\'10372\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
    ...
    Image count:2
    Text that these images have in common (case-sensitive):\\w*\x5BC-D\x5D\\w*06\\w*w1.TIF
    ...
    Channel number:1
    Text that these images have in common (case-sensitive):\\w*\x5BC-D\x5D\\w*06\\w*w3.TIF
