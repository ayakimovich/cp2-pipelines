...
LoadImages:[module_num:1|svn_version:\'9976\'|variable_revision_number:6|show_window:False|notes:\x5B\x5D]
    ...
    Image count:3
    Text that these images have in common (case-sensitive):w1.TIF
    ...
    Channel number\x3A:1
    Text that these images have in common (case-sensitive):w3.TIF
...
IdentifyPrimaryObjects:[module_num:2|svn_version:\'9856\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
...
IdentifySecondaryObjects:[module_num:3|svn_version:\'9741\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
...
IdentifyTertiaryObjects:[module_num:4|svn_version:\'9429\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Select the larger identified objects:Cells
    Select the smaller identified objects:Nuclei
    Name the tertiary objects to be identified:Prestained
    Name the outline image:CytoplasmOutlines
    Retain outlines of the tertiary objects?:No

MeasureObjectIntensity:[module_num:5|svn_version:\'9645\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Hidden:2
    Select an image to measure:GFP
    Select an image to measure:PI
    Select objects to measure:Cells
    Select objects to measure:Prestained

FilterObjects:[module_num:6|svn_version:\'9939\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
...
FilterObjects:[module_num:7|svn_version:\'9939\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
    Name the output objects:PrestainedCells
    Select the object to filter:Prestained
    Filter using classifier rules or measurements?:Measurements
    Select the filtering method:Limits
    ...
    Measurement count:1
    Additional object count:0
    Select the measurement to filter by:Intensity_MeanIntensity_PI
    Filter using a minimum measurement value?:Yes
    Minimum value:0.0016
    Filter using a maximum measurement value?:No
    Maximum value:1
