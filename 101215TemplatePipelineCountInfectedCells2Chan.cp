...
LoadImages:[module_num:1|svn_version:\'11587\'|variable_revision_number:11|show_window:False|notes:\x5B\x5D]
    ...
    Input image file location:Elsewhere...\x7CD\x3A\\Artur\\PhD Project\\CP2.0_Pipelines\\Spreaders_Assay
    ...
    Channel number:1
    Rescale intensities?:Yes
    Text that these images have in common (case-sensitive):Mask-inv
    ...
    Load the input as images or objects?:Images
    Name this loaded image:WellMask
    Name this loaded object:Nuclei
    Retain outlines of loaded objects?:No
...
MaskImage:[module_num:2|svn_version:\'10428\'|variable_revision_number:3|show_window:True|notes:\x5B\x5D]
    Select the input image:Nuclei
    Name the output image:MaskedNuclei
    Use objects or an image as a mask?:Image
    Select object for mask:None
    Select image for mask:WellMask
    Invert the mask?:No

MaskImage:[module_num:3|svn_version:\'10428\'|variable_revision_number:3|show_window:True|notes:\x5B\x5D]
    Select the input image:VirusSignal
    Name the output image:MaskedVirusSignal
    Use objects or an image as a mask?:Image
    Select object for mask:None
    Select image for mask:WellMask
    Invert the mask?:No
...
MeasureObjectIntensity:[module_num:7|svn_version:\'10816\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Hidden:1
